...
모든 테이블 접두사: `patentai_`
- patentai_prompts — 프롬프트 관리
- patentai_patent_projects — 특허 프로젝트
- patentai_patent_inputs — 입력 소스 (텍스트/파일)
- patentai_patent_components — 구성요소 트리 (참조번호 체계)
- patentai_patent_prior_art — 선행기술 조사 결과
- patentai_patent_claims — 청구항
- patentai_patent_sections — 명세서 섹션 (9개)
- patentai_patent_drawings — 특허 도면
- patentai_patent_gates — GATE 승인 이력 (1~5)
